...
namespace UnityEngine.XR.Interaction.Toolkit
{
    ...
    [AddComponentMenu("XR/ZeroGravity Interactable", 11)]
    public class ZeroGravityInteractable : XRBaseInteractable
    {
        ...
        ZeroGravityLocomotion m_ClimbProvider;

        [SerializeField] private GameObject physicsLeftHand;
        [SerializeField] private GameObject physicsRightHand;

        /// <summary>
        /// The climb provider that performs locomotion while this interactable is selected.
        /// If no climb provider is configured, will attempt to find one.
        /// </summary>
        public ZeroGravityLocomotion climbProvider
        {
            get => m_ClimbProvider;
        ...
        //{
        //    //Debug.Log("Interactable: " + args.interactableObject.transform.gameObject.name + ", " + args.interactableObject.interactorsHovering.Count);
        //    //Debug.Log("Interactor: " + args.interactorObject.transform.gameObject.name + ", " + args.interactorObject.interactablesHovered.Count);

        //    XRDirectInteractor xdi = args.interactorObject.transform.GetComponent<XRDirectInteractor>();
        //    Debug.Log(xdi.interactablesHovered.Count);

        //    base.OnHoverEntered(args);
        //}

        //public bool handBusy = false;
        /// <inheritdoc />
        protected override void OnSelectEntered(SelectEnterEventArgs args)
        {
            XRDirectInteractor xdi = args.interactorObject.transform.GetComponent<XRDirectInteractor>();
            if (xdi.interactablesHovered.Count > 1) return;
            base.OnSelectEntered(args);
            args.interactorObject.transform.gameObject.GetComponentInChildren<AnimateHandOnInput>().MakeHandNotVisible();
        ...
        protected override void OnSelectExited(SelectExitEventArgs args)
        {
            ...
            args.interactorObject.transform.gameObject.GetComponentInChildren<AnimateHandOnInput>().MakeHandVisible();
